...
class UserJpaRepositoryTest {
    ...
    void findByEmailAndStatus_를_사용하여_유저_데이터를_가져올_수_있다() {
        // given
        // when
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("thstkddnr20@naver.com", UserStatus.ACTIVE);
    ...
    void findByEmailAndStatus_는_데이터가_없으면_Optional_empty를_내려준다() {
        // given
        // when
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("thstkddnr20@naver.com", UserStatus.PENDING);
